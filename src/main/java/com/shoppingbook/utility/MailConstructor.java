...
public class MailConstructor {
	...
	public SimpleMailMessage constructResetTokenEmail(String contextPath, Locale locale, 
		...
		email.setSubject("G3's Bookstore - New User");
	...
	public MimeMessagePreparator constructOrderConfirmationEmail(User user, Order order, Locale locale) {
		...
		context.setVariable("cartItemList", order.getCarttItems());
		...
		MimeMessagePreparator messagePreparator = new MimeMessagePreparator() {
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				email.setFrom(new InternetAddress("group3t11805e0@gmail.com"));
			}
		};
